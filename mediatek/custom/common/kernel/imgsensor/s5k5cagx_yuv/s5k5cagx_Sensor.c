...
// Outdoor CCM
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0012); //add saturation
//================================================================================================
// SET AWB
//================================================================================================
// Indoor boundary
...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
  ...
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);//0000	//awbb_GridCorr_R[9] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);//FFF0	//awbb_GridCorr_R[10] //   
  ...
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);//0032	//awbb_GridCorr_B[8] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);//0000	//awbb_GridCorr_B[9] //                                                                          
...
BOOL S5K5CAGX_set_param_wb(UINT16 para)
{
	...
	wb_mode = para;		//add by jinlin.Hu for fix pr371938.
...
#endif
/*add by jinlin.Hu for fix pr378103. start*/
void S5K5CAGXGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 0;
    SENSORDB(" S5K5CAGXGetAFMaxNumFocusAreas, *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}

void S5K5CAGXGetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 0;
    SENSORDB(" S5K5CAGXGetAFMaxNumMeteringAreas,*pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);

}
/*add by jinlin.Hu for fix pr378103. end*/

/*add by jinlin.Hu for fix pr371938. start*/
void S5K5CAGXGetExifInfo(UINT32 *exifAddr)
{
        SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
       // pExifInfo->AEISOSpeed = AE_ISO_100;
        pExifInfo->AWBMode = wb_mode;
       // pExifInfo->CapExposureTime = 0;
        //pExifInfo->FlashLightTimeus = 0;
       // pExifInfo->RealISOValue = AE_ISO_100;
}
/*add by jinlin.Hu for fix pr371938. end*/
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
        		S5K5CAGXGetAFMaxNumFocusAreas(pFeatureReturnPara32);            
        		*pFeatureParaLen=4;
        		break;     
    		case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
        		S5K5CAGXGetAFMaxNumMeteringAreas(pFeatureReturnPara32);            
        		*pFeatureParaLen=4;
        		break;
		/*add by jinlin.Hu for fix pr378103. end*/    
		default:
