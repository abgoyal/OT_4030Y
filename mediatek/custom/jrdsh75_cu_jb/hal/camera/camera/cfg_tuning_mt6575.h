...
{
        //PR-366827-YangYiBin-Begin-add customization for latum request
	char value[32] = {'\0'};
        property_get("ro.camera.smilethreshold", value, "5");
        MINT8 SmileThreshold = atoi(value);
        XLOGD("camera_smile_detect_level SmileThreshold: %d.\n", SmileThreshold);
        //PR-366827-YangYiBin-End
