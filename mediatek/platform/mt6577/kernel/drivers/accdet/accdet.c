...
int CallStatusForCharging = 0;
EXPORT_SYMBOL(CallStatusForCharging);
...
/* the old ACCDE driver legacy */
		...
		case SET_CALL_STATE :
			call_status = (int)arg;
			CallStatusForCharging=(int)arg;
			//printk("CHENFEI CallStatusForCharging %d \n",CallStatusForCharging);
